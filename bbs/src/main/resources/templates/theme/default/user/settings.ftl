                    ...
                    <#if coinWalletMap['INFINITE_COIN']??>
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><button type="button" id="ifcTransferBtn" class="btn btn-info" onclick="openSendCoin(true,'INFINITE_COIN','','',1000,'${_user.username}','${_user.token}')">转账</button></td>
                            </tr>
                        </table>
                    </#if>
                    <form onsubmit="return;" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <div class="offset-sm-2 col-sm-10">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="ifcRememberPassword" id="ifcRememberPassword" checked>记住密码。<p style="font-size: 25px;color: red;">请牢记您的个人钱包密码，搞丢后没人能恢复！！！</p>
                                        <br/>
